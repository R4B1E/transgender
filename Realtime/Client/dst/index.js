...
realtime.onConnection(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var i, MatchmakingRoomName;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                MatchmakingRoomName = "".concat(clientId, "-Matchmaking");
                console.log(MatchmakingRoomName);
                realtime.publish("StartGame", { id: clientId, mode: "Multiplayer" }, true);
                return [4 /*yield*/, realtime.subscribe(clientId + "-Matchmaking", function (message) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
